...
4. TARGET: ${target || 'none'}. WAJIB memory_get({id:"RUNBOOK_${(target || 'none').replace(/[^a-zA-Z0-9._-]/g, '_')}.md"}) (UNLOCK) lalu Read .md bertahap (BACA ISI UTUH) sebelum action. memory_get saja BUKAN "sudah baca".
